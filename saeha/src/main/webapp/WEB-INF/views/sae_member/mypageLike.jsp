...
<thead>
<tr><th>번호</th><th>제목</th><th>이미지</th><th>수용인원</th><th>프로그램기간</th><th>예약기간</th><th>분류</th></tr>
</thead>

<c:forEach items="${likelist}" var = "likelist">
<tr>
<td><c:out value="${likelist.pg_bno}" href="/sae_book/bookview/likelist?lk_id=${likelist.lk_id}"/></td>
...
<c:if test="${member.userId != null}">
  <button type="button">
   <!--  <a href="/sae_book/book">프로그램 추가</a> -->
  </button>
</c:if>
</ul>
</div>
