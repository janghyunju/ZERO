...
public class PdReplyDAOImpl implements PdReplyDAO{
	...
	@Override
	public List<PdReplyVO> pdReply(int py_bno) throws Exception {
		return sql.selectList("pdreplyMapper.pdReply", py_bno);
	}
	
	//답변 등록
	@Override
	public void pdreplywrite(PdReplyVO vo) throws Exception {
		sql.insert("pdreplyMapper.pdreplywrite", vo);
	}
