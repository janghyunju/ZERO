...
public class ProductController {
	...
	private static final String CURR_IMAGE_REPO_PATH = "/Users/janghyeonju/Desktop/Study/spring_1123/workspace_1/saeha/src/main/webapp/resources/productimg/";
...
//			댓글을 작성했던 게시물로 이동.
		...
		//문의사항 목록
		@RequestMapping(value = "/pdreply", method = RequestMethod.GET)
		public String pdreply(ProductVO prodcutVO, Model model) throws Exception {
			logger.info("답변 보기 성공");
			
			model.addAttribute("pdreply", replyService.pdReply(prodcutVO.getPd_bno()));
			
			return "sae_product/pdreply";
		}
		
		// 문의사항 답변 view
		@RequestMapping(value = "/pdreplywriteView", method = RequestMethod.GET)
		public void pdreplywriteview() throws Exception {
			logger.info("pdreplywriteview");
		}
		
		//문의사항 답변 등록
		@RequestMapping(value = "/pdreplywrite", method = RequestMethod.POST)
		public String pdreplywrite(PdReplyVO vo) throws Exception {
			logger.info("답변 등록 성공");
			
			replyService.pdreplywrite(vo);
			
			//return "redirect:/sae_product/read?pd_bno=" + vo.getPy_bno();
			return "redirect:/sae_product/read";
		}
